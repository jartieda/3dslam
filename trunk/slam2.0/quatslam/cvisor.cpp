...
osg::Geode* myKeyboardEventHandler::CameraUncertainty()
{
...
//                cvmSet(vect,5,0,pSlam->randomVector(-1,1));
                cvmSet(vect,0,0,pSlam->randomVector(-1,1));
                cvmSet(vect,1,0,pSlam->randomVector(-1,1));
                cvmSet(vect,2,0,pSlam->randomVector(-1,1));
                cvmSet(vect,3,0,pSlam->randomVector(-1,1));
                cvmSet(vect,4,0,pSlam->randomVector(-1,1));
                cvmSet(vect,5,0,pSlam->randomVector(-1,1));
                cvZero(_temp);
